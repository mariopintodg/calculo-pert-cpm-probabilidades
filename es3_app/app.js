...
(function () {
  ...
  function renderHeader() {
    ...
    $('#sourceName').textContent = 'Excel ES3 · Grupo 4';
    $('#sourceName').title = D.sourceFile;
  }
  ...
  function overview() {
    ...
    return `<div class="dashboard-stage"><div class="dashboard-intro"><div><span class="dashboard-kicker">CENTRO DE CONTROL · GRUPO 4</span><h3>La obra, de principio a fin</h3><p>Planificación, presupuesto y control de la Sede Social El Bosque en una sola experiencia visual.</p></div><button class="theme-toggle" id="themeToggle" aria-label="Cambiar tema">${state.theme === 'dark' ? '☀ Tema claro' : '☾ Tema oscuro'}</button></div>
    <div class="digital-twin"><div class="twin-copy"><span class="live-indicator"><i></i> MODELO INTEGRADO ES3</span><h4>Una obra.<br><em>Todos sus datos conectados.</em></h4><p>Desde la primera cuadrilla hasta el último estado de pago: cada módulo explica qué ocurre, cuánto dura y cómo impacta el resultado.</p><div class="twin-actions"><button class="twin-primary" data-tab="04">Explorar la red CPM <span>↗</span></button><button class="twin-secondary" data-tab="05">Ver Carta Gantt <span>→</span></button></div><div class="twin-stats"><div><b>${Math.round(cpm.projectFinish)}</b><span>días de programa</span></div><div><b>${state.activities.length}</b><span>actividades vinculadas</span></div><div><b>${TABS.length}</b><span>módulos de análisis</span></div></div></div><div class="twin-art" aria-hidden="true"><div class="twin-orbit orbit-one"></div><div class="twin-orbit orbit-two"></div><div class="twin-scan"></div><svg viewBox="0 0 600 440" role="presentation"><defs><linearGradient id="twinEdge" x1="0" x2="1" y1="0" y2="1"><stop stop-color="#38f2d5"/><stop offset="1" stop-color="#67a9ff"/></linearGradient><linearGradient id="twinFace" x1="0" x2="1" y1="0" y2="1"><stop stop-color="#0c7d98" stop-opacity=".33"/><stop offset="1" stop-color="#23508f" stop-opacity=".12"/></linearGradient><filter id="twinGlow"><feGaussianBlur stdDeviation="4" result="b"/><feMerge><feMergeNode in="b"/><feMergeNode in="SourceGraphic"/></feMerge></filter></defs><g class="twin-ground"><path d="M42 286 293 400 562 269 309 153Z" fill="#0a3553" fill-opacity=".4" stroke="#3f86ae" stroke-opacity=".4"/><path d="M72 289 294 389 533 271M104 302 322 201M151 323 370 222M198 344 419 244M245 366 468 267" fill="none" stroke="#48a4c7" stroke-opacity=".18"/></g><g class="twin-building" stroke="url(#twinEdge)" stroke-width="2" stroke-linejoin="round"><path d="M143 169 301 93 478 169 320 248Z" fill="#1a6284" fill-opacity=".22"/><path d="M143 169V297l177 80V248Z" fill="url(#twinFace)"/><path d="M320 248V377l158-81V169Z" fill="#0d345f" fill-opacity=".5"/><path d="M143 169 301 93 478 169 320 248 143 169ZM143 169v128l177 80 158-81V169M320 248v129" fill="none"/><path d="M197 193v128m54-103v128m54-103v128M372 222v128m54-154v128M143 231l177 80 158-81M143 264l177 80 158-81" fill="none" stroke-opacity=".55"/><path d="M215 203 373 127M268 227l158-77M197 321l54 24v-81l-54-24v81Zm175 29 55-28v-81l-55 28v81Z" fill="none" stroke-opacity=".48"/></g><g class="twin-highlight" fill="none" stroke="#56f2d6" stroke-width="3" filter="url(#twinGlow)"><path d="M143 169 301 93 478 169"/><path d="M320 248v129"/></g><g fill="#69f9e2" filter="url(#twinGlow)"><circle class="pulse-dot" cx="143" cy="169" r="5"/><circle class="pulse-dot delayed" cx="301" cy="93" r="5"/><circle class="pulse-dot" cx="478" cy="169" r="5"/><circle class="pulse-dot delayed" cx="320" cy="377" r="5"/></g><g fill="#b9e8fa" font-family="system-ui" font-size="12" font-weight="700"><text x="319" y="74">PLANIFICACIÓN</text><text x="489" y="165">EJECUCIÓN</text><text x="19" y="165">CONTROL</text><text x="334" y="406">ENTREGA</text></g><g fill="none" stroke="#60b8da" stroke-opacity=".7"><path d="M303 88V54h113M482 166h80M140 167H58M322 380v31h110"/></g></svg><span class="twin-corner corner-a">01 / MODELO DIGITAL</span><span class="twin-corner corner-b">ANDACOLLO · CHILE</span></div></div>
